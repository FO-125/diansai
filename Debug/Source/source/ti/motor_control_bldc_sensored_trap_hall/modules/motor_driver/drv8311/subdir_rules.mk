...
Source/source/ti/motor_control_bldc_sensored_trap_hall/modules/motor_driver/drv8311/%.o: ../Source/source/ti/motor_control_bldc_sensored_trap_hall/modules/motor_driver/drv8311/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
