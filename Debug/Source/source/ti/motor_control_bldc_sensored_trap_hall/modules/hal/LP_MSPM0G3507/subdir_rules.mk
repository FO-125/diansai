...
Source/source/ti/motor_control_bldc_sensored_trap_hall/modules/hal/LP_MSPM0G3507/%.o: ../Source/source/ti/motor_control_bldc_sensored_trap_hall/modules/hal/LP_MSPM0G3507/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	@echo 'Building file: "$<"'
